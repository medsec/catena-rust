//! An implementation of Catena-Mydasfly. This variant of Catena provides
//! resistance to ASIC-based adversaries.

/// The choices for H, H', F, Γ and Φ for Catena-Mydasfly.
///
/// These choices are:
///
/// - H: Blake2b
...
pub struct MydasflyAlgorithms;

impl ::catena::Algorithms for MydasflyAlgorithms {
...
/// Constructor for a Catena-Mydasfly instance.
pub fn new() -> ::catena::Catena<MydasflyAlgorithms> {
    let mf_algorithms = MydasflyAlgorithms;
    ::catena::Catena {
        algorithms: mf_algorithms,
        vid: "Mydasfly",
        n: 64,
        k: 1024,
        g_low: 14,
...
mod tests {
    ...
    #[test]
    fn mydasfly_reduced_test_from_json() {
        let mut test_catena = new();
        test_catena.g_low = 9;
        test_catena.g_high = 9;
        catena_test_from_json(test_catena, "test/test_vectors/catenaMydasflyReduced.json");
    }

    #[test]
    #[cfg(feature="fulltest")]
    fn mydasfly_test_from_json() {
        let test_catena = new();
        catena_test_from_json(
            test_catena, "test/test_vectors/catenaMydasfly.json");
    }
}
